/**************************************************************
 * \file main.C
 * \brief Main source code of the program: define default options for parameters and call the functions in order to execute the program
 *
 *
 *
...
{
<<<<<<< HEAD
    // to initialize default values for options
    ...
    int mode=1;
    // replace the default options with the customized ones when written on command
=======
...
>>>>>>> 645e845f2788af9bc5da4534e84fc6311956412d
